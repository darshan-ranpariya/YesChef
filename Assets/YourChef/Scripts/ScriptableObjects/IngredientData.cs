...
public enum IngredientType { Vegetable, Cheese, Meat }
public enum IngredientState { Raw, Prepped }
...
public class IngredientData : ScriptableObject
{
    ...
    [Tooltip("Used to change the color of our primitive shapes based on state.")]
